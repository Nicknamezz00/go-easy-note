...
func (x *BaseResp) GetTimestamp() int64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
func (x *GetUsersResponse) GetBaseResp() *BaseResp {
	if x != nil {
		return x.BaseResp
	}
	return nil
...
var file_idl_user_proto_rawDesc = []byte{
	...
	0x12, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x63, 0x0a, 0x08, 0x42, 0x61, 0x73, 0x65, 0x52, 0x65,
	...
	0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x54, 0x0a, 0x04, 0x55,
	...
	0x72, 0x22, 0x4c, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x52,
	...
	0x41, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73,
	...
	0x73, 0x70, 0x22, 0x2c, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x73, 0x52, 0x65,
	...
	0x22, 0x61, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x73, 0x52, 0x65, 0x73, 0x70,
	...
	0x70, 0x52, 0x08, 0x62, 0x61, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70, 0x32, 0xcc, 0x01, 0x0a, 0x0b,
	...
	0x2d, 0x65, 0x61, 0x73, 0x79, 0x2d, 0x6e, 0x6f, 0x74, 0x65, 0x2f, 0x6b, 0x69, 0x74, 0x65, 0x78,
...
var file_idl_user_proto_depIdxs = []int32{
	...
	0, // 2: user.GetUsersResponse.base_resp:type_name -> user.BaseResp
	...
	4, // 5: user.UserService.GetUsers:input_type -> user.GetUsersRequest
	6, // 6: user.UserService.CheckUser:input_type -> user.CheckUserRequest
	7, // 7: user.UserService.CreateUser:output_type -> user.CheckUserResponse
	5, // 8: user.UserService.GetUsers:output_type -> user.GetUsersResponse
...
type UserService interface {
	CreateUser(ctx context.Context, req *CreateUserRequest) (res *CheckUserResponse, err error)
