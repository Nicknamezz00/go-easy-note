...
import (
	...
	note "go-easy-note/kitex_gen/note"
)
...
func NewServiceInfo() *kitex.ServiceInfo {
	...
	methods := map[string]kitex.MethodInfo{
		...
		"GetNotes":   kitex.NewMethodInfo(getNotesHandler, newNoteServiceGetNotesArgs, newNoteServiceGetNotesResult, false),
...
func getNotesHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*note.NoteServiceGetNotesArgs)
	realResult := result.(*note.NoteServiceGetNotesResult)
	success, err := handler.(note.NoteService).GetNotes(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newNoteServiceGetNotesArgs() interface{} {
	return note.NewNoteServiceGetNotesArgs()
}

func newNoteServiceGetNotesResult() interface{} {
	return note.NewNoteServiceGetNotesResult()
}
...
func (p *kClient) DeleteNote(ctx context.Context, req *note.DeleteNoteRequset) (r *note.DeleteNoteResponse, err error) {
...
func (p *kClient) GetNotes(ctx context.Context, req *note.GetNotesRequest) (r *note.GetNotesResponse, err error) {
	var _args note.NoteServiceGetNotesArgs
	_args.Req = req
	var _result note.NoteServiceGetNotesResult
	if err = p.c.Call(ctx, "GetNotes", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
